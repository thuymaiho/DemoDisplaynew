	...
	<div class="header">
		...
		<%} %>
							<li> <a href="checkout.jsp" >Cart</a> </li>	
									<%if(tk!=null){ %>
					<li> <a href="LoginController?action=Logout" >Sign out</a> </li>	
					<%} %>
		...
		<div class="header-bottom-in">
			...
			<p class="wel"><a href="Register.jsp">Hello our dear customer! If you don't have an account, you need to register.</a></p>
