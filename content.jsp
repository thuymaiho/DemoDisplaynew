...
<body>
			...
			<div class="content">
				<div class="content-top">
					...
					<div class="col-md-3 md-col">
							<div class="col-md">
								<a><img  src="images/oppo9.jpg" alt="" /></a>	
					...
					<%-- <div class="col-md-3 md-col">
							<div class="col-md">
								<a href=products.jsp?ChuyenMuc=CM01  class="hvr-shutter-in-vertical hvr-shutter-in-vertical2"><img  src="images/oppolatest.jpg" alt="" />	
								<div class="top-content">
									<center><h5>OPPO Reno6 Z 5G</h5></center></a>
									<div class="white">
										<a href=products.jsp?ChuyenMuc=CM01  class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">Xem thêm</a>	
										<p class="dollar"><span class="in-dollar">7690000</span><span>Đ</span></p>
										<div class="clearfix"></div>
	...
	<script type="text/javascript" src="js/jquery.flexisel.js"></script>
				...
				<div class="content-bottom">
					<h3 class="future">AVAILABLE IN WEBS</h3>
					<div class="content-bottom-in">
					<ul id="flexiselDemo2">			
					
					<div class="col-md-3 md-col">
							<div class="col-md">
								<a><img  src="images/sontung.jpg" alt="" /></a>	
								<div class="top-content">
									<center><h5><a>Điện thoại Oppo F9 64GB</a></h5></center>
									<div class="white">
										<a href=products.jsp?ChuyenMuc=CM01  class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">Xem thêm</a>	
